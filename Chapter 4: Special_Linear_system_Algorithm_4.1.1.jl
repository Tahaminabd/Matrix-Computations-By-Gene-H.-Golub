...
# ╔═╡ 06d3e396-5fa4-468f-a706-cb3b1c6d4d3b
begin
	using PyPlot
...
# ╔═╡ ab81242b-7845-4e5b-a42e-05b68e8f1222
# Define a function to perform the LDL^T factorization
function LDLT_factorization(A)
    n = size(A, 1)
    L = Matrix{Float64}(I, n, n)  # Initialize the unit lower triangular matrix L
    D = zeros(Float64, n, n)      # Initialize the diagonal matrix D
...
# ╔═╡ 4d3d92a0-2552-482c-a256-70911cc31e10
# Example usage
A = [5.0 2.0 2.0; 2.0 5.0 4.0; 2.0 4.0 6.0]  # Replace with symmetric matrix

# ╔═╡ 2c42dcc6-cba5-437a-b13d-9e5637b994c6
...
#=╠═╡
begin
	Lslider=@bind  L Slider(1:20, default=2, show_value=true)
	md"""
	`L =`$(Lslider)
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "f672c2c71c79df225780d9de9ddaee4394ae5ea0"
